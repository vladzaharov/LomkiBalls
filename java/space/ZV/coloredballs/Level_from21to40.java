...
public class Level_from21to40 extends AppCompatActivity {
        ...
        backToPause.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (lock) {
                    ...
                    window_pause = new Dialog(Level_from21to40.this);
                    ...
                    buttonExit.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            try {
                                ...
                                Intent intent = new Intent(Level_from21to40.this, MainActivity.class);
    ...
    public void resultLevel(boolean minus_life,final TextView TL, final TextView textTime, final SharedPreferences saveData, final SharedPreferences.Editor data){
        ...
        if (minus_life) {
            ...
            windowOff = new Dialog(Level_from21to40.this);
            ...
            btncloseOff.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        plusLife_Timer.cancel();
                        plusLife_Timer.purge();
                        Intent intent = new Intent(Level_from21to40.this, GameMenuLevel1_20.class);
                        startActivity(intent);
                        finish();
                    } catch (Exception e) {
            ...
            btnReturn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        plusLife_Timer.cancel();
                        plusLife_Timer.purge();
                        Intent intent = new Intent(Level_from21to40.this, GameLoading.class);
                        startActivity(intent);
                        finish();
                    } catch (Exception e) {
            ...
            windowOn = new Dialog(Level_from21to40.this);
